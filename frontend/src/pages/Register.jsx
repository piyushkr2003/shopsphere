...
const Register = () => {
  ...
  return (
    <div className="flex-grow flex items-center justify-center py-24 px-4 sm:px-6 lg:px-8 bg-slate-55 dark:bg-slate-950">
      <div className="max-w-md w-full space-y-8 bg-white dark:bg-slate-900 p-8 sm:p-10 rounded-3xl border border-slate-202 dark:border-slate-800 shadow-2xl">
        <div>
          ...
          <p className="mt-3 text-center text-base text-slate-600 dark:text-slate-400">
            ...
            <Link to="/login" className="font-bold text-indigo-600 hover:text-indigo-500 dark:text-indigo-500 dark:hover:text-indigo-400 transition-colors">
              Sign in
            </Link>
          </p>
        </div>
